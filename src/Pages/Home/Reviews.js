                        ...
                        <tbody>
                            ...
                            }
                            {
                                reviews.map((review, index) => <tr key={review._id}>
                                    ...
                                    <td style={{ color: '#1b2d45', backgroundColor: '#fffffe' }}>{review.name}</td>
                                    <td style={{ color: '#1b2d45', backgroundColor: '#fffffe' }}>{review.rating}/5</td>
                                    <td style={{ color: '#1b2d45', backgroundColor: '#fffffe' }}>{review.feedback}</td>
                                </tr>)
                            }
                        </tbody>
