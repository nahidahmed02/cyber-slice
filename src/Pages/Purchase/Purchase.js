                        ...
                        <div className='card-body'>
                            ...
                            <form className='text-center  lg:mx-32' onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="form-control w-full max-w-xs">
                                    ...
                                    <input {...register("email")} type="email" value={email} className='input input-bordered w-full max-w-xs' readOnly />
                                </div>
                                ...
                                <div className="form-control w-full max-w-xs">
                                    ...
                                    <input {...register("address")} type="text" name='address' placeholder='Your Address' className='input input-bordered w-full max-w-xs' required />
                                </div>
                                ...
                                <div className="form-control w-full max-w-xs">
                                    ...
                                    <input {...register("phone")} type="text" name='phone' placeholder='Phone Number' className='input input-bordered w-full max-w-xs' required />
                                </div>
                                {
                                    (errors.quantity < 'min' || errors.quantity > 'max')
                                        ?
                                        <input type="submit" value="Place Order" className='btn btn-disabled w-full max-w-xs mt-4' />
                                        :
                                        <input type="submit" value="Place Order" className='btn w-full max-w-xs mt-4' />
                                }
                            </form>
                        </div>
                    </div>
