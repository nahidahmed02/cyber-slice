    ...
    return (
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-content">
                <label htmlFor="dashboard-sidebar" className="drawer-button cursor-pointer lg:hidden">
                    <CgMenuRound className='text-3xl ml-4 mt-3' />
                </label>
            ...
            <div className="drawer-side mb-auto mt-14 lg:ml-3 rounded-md">
                ...
                <ul className="bg-white menu p-4 overflow-y-auto w-52 text-base-content">
                    ...
                    <li className='font-bold font-serif text-red-600 lg:mt-1'>
...

                    {
                        !admin &&
                        <>
                            <li className='font-bold font-serif text-red-600'>
                    ...
                    {/* <!-------------- visible for the admins -------------> */}

                    {
                        admin &&
                        <>
                            <li className='font-bold font-serif text-red-600'>
                                <CustomLink to="/dashboard/manageAllOrders">Manage Orders</CustomLink>
                            </li>
                            <li className='font-bold font-serif text-red-600'>
                                <CustomLink to="/dashboard/addProduct">Add A Product</CustomLink>
                            </li>
                            <li className='font-bold font-serif text-red-600'>
                                <CustomLink to="/dashboard/makeAdmin">Manage Admin</CustomLink>
                            </li>
                            <li className='font-bold font-serif text-red-600'>
