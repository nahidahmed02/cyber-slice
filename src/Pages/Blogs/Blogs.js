    ...
    return (
        <div className='mx-6 lg:mx-20 my-12'>
            <div className='card-bordered rounded-xl bg-gray-200 px-6 py-6 lg:px-20 lg:py-8 mb-8'>
                <h2 className='text-xl lg:text-2xl font-bold text-red-500'>How will you improve the performance of a React Application?</h2>
                <p className='lg:text-xl font-bold mt-2'>There are many ways to improve the performance of a React Application. Such as: <br />
            ...
            <div className='card-bordered rounded-xl bg-gray-200 px-6 py-6 lg:px-20 lg:py-8 mb-8'>
                <h2 className='text-xl lg:text-2xl font-bold text-red-500'>What are the different ways to manage a state in a React application?</h2>
                <p className='lg:text-xl font-bold mt-2'>Different ways to manage a state in a React application- <br />
            ...
            <div className='card-bordered rounded-xl bg-gray-200 px-6 py-6 lg:px-20 lg:py-8 mb-8'>
                <h2 className='text-xl lg:text-2xl font-bold text-red-500'>Why you do not set the state directly in React? For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h2>
                <p className='lg:text-xl font-bold mt-2'>We should never set the state directly in React. Some reasons behind it-
                    <br />
            ...
            <div className='card-bordered rounded-xl bg-gray-200 px-6 py-6 lg:px-20 lg:py-8 mb-4'>
                <h2 className='text-xl lg:text-2xl font-bold text-red-500'>What is a unit test? Why should write unit tests?</h2>
                <p className='lg:text-xl font-bold mt-2'>A type of software testing, where individual units or components of a software are tested to validate that each unit of the software code performs as expected, is called UNIT TEST.
                    <br />
